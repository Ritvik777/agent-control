"""JSON validation plugin with schema, type, required field, constraint, and pattern checks."""
...
@register_plugin
class JSONControlEvaluatorPlugin(PluginEvaluator[JSONControlEvaluatorPluginConfig]):
    """Comprehensive JSON validation plugin.
    ...
    config_model = JSONControlEvaluatorPluginConfig

    def __init__(self, config: JSONControlEvaluatorPluginConfig) -> None:
